...
namespace Tween
{
    ...
    public class Tween<T> : TweenBase where T : struct
    {
        ...
        public Tween(Func<T> getter, Action<T> setter, T to, float duration, T? from = null, string id = null, bool useUnscaledTime = false)
        {
        ...
        public override void Update(float scaledDt, float unscaledDt)
        {
            ...
            float dt = UseUnscaledTime ? unscaledDt : scaledDt;
